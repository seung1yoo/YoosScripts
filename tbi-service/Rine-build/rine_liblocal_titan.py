...
################################################################################
# External Programs
TOOLS_HOME="/BiO/BioTools/Rine/Tools"
#
...
BOWTIE2_BUILD_EXEC="%s/bowtie/bowtie2-2.2.4/bowtie2-build"%TOOLS_HOME
#
STAR_N_CPU=16
STAR_EXEC="%s/STAR/current/bin/Linux_x86_64/STAR"%TOOLS_HOME
STAR_PATH="staridx"
...
#
PICARD_CREATESEQUENCEDICT_EXEC="%s/Picard/picard-tools-1.127/CreateSequenceDictionary.jar"%TOOLS_HOME
#
